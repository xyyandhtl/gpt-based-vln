...
class GLEE_Model(nn.Module):
    ...
    def __init__(self, cfg, matcher, device, video_info, contras_mean):
        ...
        self.tokenizer = CLIPTokenizer.from_pretrained('/home/lingkun/Documents/vlm/sparse_vln/weights/clip-vit-base-patch32')
        self.tokenizer.add_special_tokens({'cls_token': self.tokenizer.eos_token})
        self.text_encoder = CLIPTextModel.from_pretrained('/home/lingkun/Documents/vlm/sparse_vln/weights/clip-vit-base-patch32')
