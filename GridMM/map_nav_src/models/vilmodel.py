...
class GlocalTextPathNavCMT(BertPreTrainedModel):
    ...
    def forward_navigation_per_step(
        ...
        for b in range(batch_size):
            ...
            # print('tmp_fts.shape', tmp_fts.shape)
            # print('tmp_fts.dtype', tmp_fts.dtype)
            # print('self.grid_proj.weight.dtype', self.grid_proj.weight.dtype)
            # print('self.grid_proj.bias.dtype', self.grid_proj.bias.dtype)
            tmp_fts = self.grid_proj.to(torch.float32)(tmp_fts)
